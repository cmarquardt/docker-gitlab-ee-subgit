...
[GitLab](http://gitlab.org)'s Enterprise Edition, with [SubGit](http://www.subgit.com) v3.3.6 installed and `cron` running.
...
Present images (those built after April 2019) are using Subgit v3.3.6, as does the `:latest` one.
